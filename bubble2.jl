# bubble2.jl — Similar setup to bubble.jl but with changes to simulate large density ratio between
#   the heavy and light fluid.
#
# In addition to bubble.jl, uses equation 12 for momentum/continuity equations.
...
run_driver!(
    [Stage(integrator, 20000, 1.5, "run")],
    100,
    100,
    "bubble2-output/sph",
)
